  ...
  const [successStories, setSuccessStories] = useState([
    {
      ...
      description:
        "John Doe landed a Software Engineer role after winning the IoT challenge.",
      date: "Feb 15, 2024",
    },
    {
      id: 2,
  ...
  const [suggestions] = useState([
    {
      ...
      description:
        "Create IoT solutions for agricultural monitoring and automation",
      date: "Feb 20, 2024",
        ...
        <div className="space-y-4">
          ...
          <div className="border-t pt-4">
            ...
            <div className="space-y-2">
              <button className="w-full bg-blue-600 text-white p-2 rounded-lg text-sm sm:text-base">
                Edit Challenge Details
              </button>
              <button className="w-full bg-black text-white p-2 rounded-lg text-sm sm:text-base">
                Send Reminder to Participants
              </button>
              <button className="w-full border border-green-300 text-green-800 p-2 rounded-lg text-sm sm:text-base">
                Archive Challenge
              </button>
            </div>
          </div>
                      ...
                      <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-3 space-y-3 lg:space-y-0">
                        <div className="flex-1">
                          ...
                          <p className="text-xs sm:text-sm text-gray-600">
                            {challenge.participants} participants • Due:{" "}
                            {challenge.dueDate}
                          </p>
                        </div>
                      ...
                      {suggestions.slice(0, 2).map((suggestion) => (
                        ...
                        >
                          ...
                          <p className="text-xs text-gray-500">
                            From {suggestion.company} • {suggestion.date}
                          </p>
                        </div>
                      ))}
                    </div>
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="bg-green-50 border border-green-200 rounded-lg p-3 sm:p-4">
                  ...
                  <p className="text-xs sm:text-sm text-green-700">
                    The TVET ecosystem is performing well with strong engagement
                    and growth metrics.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-xs sm:text-sm text-gray-600">
                    <li>
                      • Challenge completion rates have improved by 15% this
                      quarter
                    </li>
                    <li>
                      • Industry partners are highly satisfied with student
                      quality
                    </li>
